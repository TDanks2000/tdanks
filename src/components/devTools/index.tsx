		...
		<section id="tools" className="bg-background">
			<div className="mx-auto max-w-6xl px-4 py-5 sm:px-6">
				...
				<div className="mt-4 grid gap-10 lg:grid-cols-[1.2fr_1.8fr] lg:gap-8">
					<div>
						<h3 className="text-3xl font-extrabold tracking-tight text-neutral-950 dark:text-neutral-50">
							API Wrappers
						</h3>
						<p className="mt-1 font-serif text-[17px] text-neutral-600 dark:text-neutral-400">
						...
						<div className="mt-6 flex flex-wrap gap-3">
							<a
								...
								target="_blank"
								rel="noreferrer"
								className="inline-flex h-10 items-center gap-2 rounded-md bg-neutral-950 px-4 text-sm font-medium text-white transition-colors hover:bg-neutral-800 dark:bg-neutral-100 dark:text-neutral-950 dark:hover:bg-white"
							>
								View on GitHub
							...
							<a
								href="#work"
								className="inline-flex h-10 items-center rounded-md bg-neutral-900/5 px-4 text-sm font-medium text-neutral-800 transition-colors hover:bg-neutral-900/10 dark:bg-white/5 dark:text-neutral-200 dark:hover:bg-white/10"
							>
								Read more
							</a>
						</div>
						...
						{repos.map((repo) => {
							...
							return (
								...
								>
									...
									<p className="mt-2 flex items-center gap-2 text-[13px] font-bold text-neutral-900 dark:text-neutral-100">
									...
									<p className="mt-1 flex-1 text-[13px] leading-relaxed text-neutral-500 dark:text-neutral-400">
